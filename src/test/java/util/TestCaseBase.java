...
public class TestCaseBase{
	...
	private void newBrowserPerPercentage(String iePercentage,
		...
		float iePercent = parseFloat(iePercentage.substring(0,
				iePercentage.indexOf("%"))) / 100;
		float firefoxPercent = parseFloat(firefoxPercentage.substring(0,
	...
	private int parseFloat(String substring) {
